...
import { GALLERY, SLOGAN, SINULOG_GALLERY } from '../constants'
      ...
      <main id="main" className="subpage">
        ...
        <div id="bottom4">
          <div className="wrapper btm4_con">
            ...
            <div className="btm4_boxes gallery_grid">
              {SINULOG_GALLERY.map((item) => (
                <figure key={item.src}>
        ...
        <div id="bottom1">
          <div className="wrapper btm1_con">
            <div className="btm1_info">
              <h2>Photo gallery</h2>
              <p>More Renegade moments from parades, drills, and tribal sets.</p>
            </div>
